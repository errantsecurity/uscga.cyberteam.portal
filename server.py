...
def turn_on_user_virtual_machine():
	...
	subprocess.Popen( str('gotty -w -p ' + str(8080 + flask_login.current_user.id) + ' ./run_vm.sh "' + flask_login.current_user.vm_path + '"').split(), cwd = flask_login.current_user.vm_path )
